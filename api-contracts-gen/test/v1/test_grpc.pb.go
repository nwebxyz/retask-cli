...
const (
	Test_Test_FullMethodName = "/test.v1.Test/Test"
)
...
func (c *testClient) Test(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedTestServer) Test(context.Context, *Request) (*Response, error) {
