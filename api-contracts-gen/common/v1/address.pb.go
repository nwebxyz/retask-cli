...
type Address struct {
	...
	// @inject_tag: bson:"address1"
	Address1 string `protobuf:"bytes,1,opt,name=address1,proto3" json:"address1,omitempty" bson:"address1"`
	// @inject_tag: bson:"address2"
	Address2 string `protobuf:"bytes,2,opt,name=address2,proto3" json:"address2,omitempty" bson:"address2"`
	// @inject_tag: bson:"city"
	City string `protobuf:"bytes,3,opt,name=city,proto3" json:"city,omitempty" bson:"city"`
	// @inject_tag: bson:"state"
	State string `protobuf:"bytes,4,opt,name=state,proto3" json:"state,omitempty" bson:"state"`
	// @inject_tag: bson:"postcode"
	Postcode string `protobuf:"bytes,5,opt,name=postcode,proto3" json:"postcode,omitempty" bson:"postcode"`
	//	The two-letter code for the country of the address
	//
	// @inject_tag: bson:"country_code"
	CountryCode string `protobuf:"bytes,6,opt,name=country_code,json=countryCode,proto3" json:"country_code,omitempty" bson:"country_code"`
}
...
var file_common_v1_address_proto_rawDesc = []byte{
	...
	0x6e, 0x2e, 0x76, 0x31, 0x22, 0xaa, 0x01, 0x0a, 0x07, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	...
	0x74, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x6f, 0x73, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x6f, 0x73, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x21,
	...
	0x65, 0x42, 0x94, 0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	0x2e, 0x76, 0x31, 0x42, 0x0c, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x50, 0x72, 0x6f, 0x74,
	0x6f, 0x50, 0x01, 0x5a, 0x30, 0x6e, 0x77, 0x65, 0x62, 0x2e, 0x78, 0x79, 0x7a, 0x2f, 0x67, 0x6f,
