...
func buildManifest() manifest {
	return manifest{
		...
		Commands: []commandEntry{
			...
			{Command: "retask task list", Description: "List tasks. --assignee accepts a workspace_member_nrn (format: nweb:workspace:member:<uuid>, obtainable from retask auth whoami or retask workspace member list)", Flags: []string{"--project-id", "--status", "--assignee", "--priority"}, Example: "retask task list --project-id <id> --priority HIGH"},
